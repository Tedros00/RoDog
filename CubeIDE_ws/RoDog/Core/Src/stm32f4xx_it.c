...
/* USER CODE BEGIN EV */
extern uint32_t UltraSound_t0 , UltraSound_left , UltraSound_right , UltraSound_front;
extern RODOG_Control rodog;
extern void DIS_motors(), startup_rodog(),stop_motion();
extern lsm6dso32x_all_sources_t imu;
/* USER CODE END EV */
