...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA2     ------> ADC1_IN2
    */
    HAL_GPIO_DeInit(CURR_FB_GPIO_Port, CURR_FB_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB1     ------> ADC2_IN9
    */
    HAL_GPIO_DeInit(GPIOA, POT8_Pin|POT5_Pin);

    HAL_GPIO_DeInit(GPIOC, POT10_Pin|POT1_Pin);

    HAL_GPIO_DeInit(GPIOB, POT7_Pin|POT4_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PA3     ------> ADC3_IN3
    */
    HAL_GPIO_DeInit(GPIOC, POT12_Pin|POT3_Pin|POT6_Pin|POT9_Pin);

    HAL_GPIO_DeInit(GPIOA, POT11_Pin|POT2_Pin);
